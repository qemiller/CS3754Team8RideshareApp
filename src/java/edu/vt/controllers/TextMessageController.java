...
public class TextMessageController {
    ...
    ============================================================
     */
    public void sendTextToEmergencyContact(User user, String message) throws AddressException, MessagingException {
        ...
        try {
            ...
            mimeEmailMessage.addRecipient(Message.RecipientType.TO, 
                    new InternetAddress(user.getEmergencyContactPhoneNumber() + "@" + user.getEmergencyContactPhoneCarrier()));
